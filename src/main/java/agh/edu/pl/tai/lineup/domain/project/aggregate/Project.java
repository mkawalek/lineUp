...
public class Project {
    ...
    public Project(ProjectId projectId, String name, String description, String versionControlUrl, UserId owner, ProjectTechnologies technologies, ProjectParticipants participants, ProjectStatus status, LocalDateTime createdAt, Optional<LocalDateTime> ended, Integer gitHubCollaborators) {
        this.gitHubCollaborators = gitHubCollaborators;
        this.projectId = projectId;
        this.name = name;
        this.description = description;
